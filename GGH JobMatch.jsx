    ...
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: "Georgia, serif" }}>
        ...
        <div style={{ maxWidth: "960px", margin: "0 auto", padding: "0 24px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: "64px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              <div style={{
                width: "34px", height: "34px", borderRadius: "9px", background: C.accent,
            ...
            <div style={{ fontSize: "10px", color: C.muted, letterSpacing: "0.04em", textAlign: "right" }}>
              GO GET HIRED CONSULTING PTY LTD.
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ maxWidth: "960px", margin: "0 auto", padding: "40px 24px" }}>
          ...
          <>
            ...
            <div style={{ textAlign: "center", marginBottom: "40px" }}>
              <div style={{
                ...
                borderRadius: "20px", marginBottom: "16px", letterSpacing: "0.06em"
              }}>
              ...
              <h1 style={{
                ...
                <span style={{ color: C.accent }}>the job?</span>
              </h1>
              <p style={{ color: C.textMid, fontSize: "16px", margin: 0, lineHeight: "1.7" }}>
                Paste your resume and a job description below for an instant score,<br />
                missing keywords, and expert tips from our AI recruiter.
              </p>
            </div>
              ...
              <Card>
                ...
                <textarea value={resume} onChange={e => setResume(e.target.value)}
                  ...
                  style={{
                    ...
                    border: `1.5px solid ${resume ? C.accent : C.border}`,
                    borderRadius: "10px", padding: "14px", fontSize: "13px",
                    color: C.text, background: resume ? "#FAFFFE" : C.bg,
                    resize: "none", outline: "none", fontFamily: "Georgia, serif",
                    lineHeight: "1.7", boxSizing: "border-box", transition: "all 0.2s"
                  }} />
              </Card>
              <Card>
                ...
                <textarea value={jobDesc} onChange={e => setJobDesc(e.target.value)}
                  ...
                  style={{
                    width: "100%", height: "280px",
                    border: `1.5px solid ${jobDesc ? C.accent : C.border}`,
                    borderRadius: "10px", padding: "14px", fontSize: "13px",
                    color: C.text, background: jobDesc ? "#FAFFFE" : C.bg,
                    resize: "none", outline: "none", fontFamily: "Georgia, serif",
                    lineHeight: "1.7", boxSizing: "border-box", transition: "all 0.2s"
                  }} />
              </Card>
            ...
            <div style={{
              ...
              marginTop: "28px", paddingTop: "28px", borderTop: `1px solid ${C.border}`
            }}>
          ...
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "220px 1fr", gap: "16px", marginBottom: "16px" }}>
              <Card style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
                ...
                <div style={{
                  marginTop: "12px", background: scoreBg(result.score),
                  color: scoreColor(result.score), fontSize: "13px", fontWeight: "600",
                  padding: "6px 14px", borderRadius: "20px", display: "inline-block"
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
                <Card>
                  ...
                  <p style={{ margin: 0, fontSize: "15px", color: C.text, lineHeight: "1.6" }}>{result.verdict}</p>
                </Card>
                <Card>
                  <SectionLabel color={C.good}>Keywords Found</SectionLabel>
                  <div>{result.foundKeywords?.map(k => <Chip key={k} text={k} type="found" />)}</div>
                </Card>
                <Card>
                  <SectionLabel color={C.danger}>Keywords Missing</SectionLabel>
                  <div>{result.missingKeywords?.map(k => <Chip key={k} text={k} type="missing" />)}</div>
                </Card>
              </div>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
              <Card>
                ...
                {result.strengths?.map((s, i) => (
                  <div key={i} style={{
                    ...
                    borderBottom: i < result.strengths.length - 1 ? `1px solid ${C.borderLight}` : "none"
                  }}>
                    <div style={{
                      width: "20px", height: "20px", borderRadius: "50%",
                      background: C.goodLight, color: C.good, fontSize: "10px",
                      display: "flex", alignItems: "center", justifyContent: "center",
                      flexShrink: 0, fontWeight: "700", marginTop: "2px"
                    }}>✓</div>
              ...
              <Card>
                ...
                {result.weaknesses?.map((w, i) => (
                  <div key={i} style={{
                    display: "flex", gap: "10px", alignItems: "flex-start", padding: "10px 0",
                    borderBottom: i < result.weaknesses.length - 1 ? `1px solid ${C.borderLight}` : "none"
                  }}>
                    <div style={{
                      width: "20px", height: "20px", borderRadius: "50%",
                      background: C.dangerLight, color: C.danger, fontSize: "10px",
                      display: "flex", alignItems: "center", justifyContent: "center",
                      flexShrink: 0, fontWeight: "700", marginTop: "2px"
                    }}>!</div>
            ...
            <Card style={{ marginBottom: "16px" }}>
              ...
              {result.tips?.map((t, i) => (
                <div key={i} style={{
                  ...
                  borderBottom: i < result.tips.length - 1 ? `1px solid ${C.borderLight}` : "none"
                }}>
                  <div style={{
                    background: "#EEF2FF", color: "#4338CA", border: "1px solid #C7D2FE",
                    borderRadius: "6px", padding: "3px 10px", fontSize: "10px",
                    fontWeight: "600", letterSpacing: "0.06em", flexShrink: 0, marginTop: "2px"
            ...
            <div style={{
              ...
              <div>
                <div style={{ color: "white", fontWeight: "700", fontSize: "16px", marginBottom: "4px" }}>
                  Want a professionally rewritten resume?
                </div>
                <div style={{ color: "rgba(255,255,255,0.8)", fontSize: "13px" }}>
                  Our experts at Go Get Hired Consulting Pty Ltd. will rewrite your resume to maximise your chances.
                </div>
              </div>
              <button style={{
                background: "white", color: C.accent, border: "none", borderRadius: "10px",
                padding: "12px 22px", fontSize: "13px", fontWeight: "700",
                fontFamily: "Georgia, serif", cursor: "pointer", whiteSpace: "nowrap",
                flexShrink: 0, marginLeft: "20px", boxShadow: "0 2px 8px rgba(0,0,0,0.1)"
              }}>Get Expert Help →</button>
            </div>

            <button onClick={() => { setResult(null); setResume(""); setJobDesc(""); setError(""); }}
              style={{
                width: "100%", background: "transparent", color: C.textMid,
                border: `1.5px solid ${C.border}`, borderRadius: "12px",
                padding: "14px", fontSize: "14px", fontFamily: "Georgia, serif",
                cursor: "pointer"
              }}>
        ...
        <div style={{
          ...
          borderTop: `1px solid ${C.border}`, color: C.muted, fontSize: "11px", letterSpacing: "0.03em"
        }}>
