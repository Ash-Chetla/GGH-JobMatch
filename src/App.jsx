      ...
      <div style={{ background: C.white, borderBottom: `1px solid ${C.border}`, boxShadow: "0 1px 0 rgba(0,0,0,0.04)" }}>
        <div style={{ maxWidth: "960px", margin: "0 auto", padding: "0 24px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: "64px" }}>
            ...
            <img src="/IMG_7657.jpg" alt="Go Get Hired Consulting" style={{ width: "40px", height: "40px", borderRadius: "9px", objectFit: "cover" }} />
          ...
          <>
            ...
            <div style={{ textAlign: "center", marginBottom: "40px" }}>
              ...
              <p style={{ color: C.textMid, fontSize: "16px", margin: 0, lineHeight: "1.7" }}>
                Paste your resume and job description below<br />for an instant score and expert tips.
              </p>
            </div>

            {/* Tip Box */}
            <div style={{ background: C.accentLight, border: `1px solid #B7E4CC`, borderRadius: "10px", padding: "12px 16px", marginBottom: "16px", fontSize: "13px", color: C.accent }}>
              💡 <strong>Have a PDF resume?</strong> Open it → Select All (Ctrl+A) → Copy (Ctrl+C) → Paste below
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
              <Card>
                ...
                <textarea value={resume} onChange={e => setResume(e.target.value)}
                  ...
                  style={{ width: "100%", height: "260px", border: `1.5px solid ${resume ? C.accent : C.border}`, borderRadius: "10px", padding: "14px", fontSize: "13px", color: C.text, background: resume ? "#FAFFFE" : C.bg, resize: "none", outline: "none", fontFamily: "Georgia, serif", lineHeight: "1.7", boxSizing: "border-box", transition: "all 0.2s" }} />
              </Card>
              <Card>
                <SectionLabel>Job Description</SectionLabel>
                <textarea value={jobDesc} onChange={e => setJobDesc(e.target.value)}
                  placeholder="Paste the job description here..."
                  style={{ width: "100%", height: "260px", border: `1.5px solid ${jobDesc ? C.accent : C.border}`, borderRadius: "10px", padding: "14px", fontSize: "13px", color: C.text, background: jobDesc ? "#FAFFFE" : C.bg, resize: "none", outline: "none", fontFamily: "Georgia, serif", lineHeight: "1.7", boxSizing: "border-box", transition: "all 0.2s" }} />
              </Card>
            </div>
          ...
          <>
            ...
            <div style={{ background: "linear-gradient(135deg, #1A7A4A 0%, #2EA86A 100%)", borderRadius: "16px", padding: "24px 28px", marginBottom: "16px", display: "flex", justifyContent: "space-between", alignItems: "center", boxShadow: "0 8px 24px rgba(26,122,74,0.2)" }}>
              ...
              <div style={{ display: "flex", gap: "10px", flexShrink: 0, marginLeft: "20px" }}>
                <a href="tel:+61435475840" style={{ background: "white", color: C.accent, borderRadius: "10px", padding: "12px 20px", fontSize: "13px", fontWeight: "700", fontFamily: "Georgia, serif", whiteSpace: "nowrap", boxShadow: "0 2px 8px rgba(0,0,0,0.1)", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "6px" }}>📞 Call Us</a>
                <a href="https://www.gogethired.com.au" target="_blank" rel="noreferrer" style={{ background: "transparent", color: "white", border: "2px solid rgba(255,255,255,0.7)", borderRadius: "10px", padding: "12px 20px", fontSize: "13px", fontWeight: "700", fontFamily: "Georgia, serif", whiteSpace: "nowrap", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "6px" }}>🌐 Our Website</a>
              </div>
            </div>
